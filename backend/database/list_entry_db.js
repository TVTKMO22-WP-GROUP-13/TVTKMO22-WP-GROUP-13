...
const sql = {
    ...
    REMOVE_LIST_ENTRY: 'DELETE FROM list_entry WHERE user_id=$1 AND media_id=$2 AND list_type=$3',
}
...
async function removeListEntry(user_id, media_id, list_type){
    await pgPool.query(sql.REMOVE_LIST_ENTRY, [user_id, media_id, list_type]);
}
