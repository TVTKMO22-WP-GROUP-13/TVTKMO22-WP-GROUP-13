...
const sql = {
    ...
    ADD_SHOWTIME: 'INSERT INTO showtime (showtime, theater_name, group_id, movie_title) VALUES ($1, $2, $3, $4)',
...
async function addShowtime(showtime, theater_name, group_id,  movie_title){
    await pgPool.query(sql.ADD_SHOWTIME, [showtime, theater_name, group_id, movie_title]);
}

async function deleteShowtime(group_id, showtime_id){
    await pgPool.query(sql.DELETE_GROUP, [group_id, showtime_id]);
}
