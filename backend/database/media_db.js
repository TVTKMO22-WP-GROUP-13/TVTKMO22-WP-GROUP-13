...
const sql = {
    ...
    GET_MEDIA_BY_TMDB_ID: 'SELECT * FROM media WHERE tmdb_id=$1',
...
async function getMediaByTmdbId(tmdb_id) {
    let result = await pgPool.query(sql.GET_MEDIA_BY_TMDB_ID, [tmdb_id]);
    return result.rows[0];
}
...
module.exports = {getAllMedia, getMediaById, getMediaByTmdbId, addMedia, deleteMedia}
